<template>
  <div class="row">
    <div class="mt-5 col-3 text-center" v-for="f in features" :key="f.name">
    ...
    features: [
      {
        ...
        bullets: [
          "Adaptation of core orientation class to your bootcamp as needed.",
        ],
        icon: "branch",
      },
      {
      ...
      {
        name: "Student Success Management",
        bullets: [
