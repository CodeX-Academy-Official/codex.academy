  ...
  <div class="deferred-payment">
    ...
    <div class="container mt-5">
      ...
      <p class="mb-5 text-left">
        We believe so strongly in YOU and our process, that we're willing to bet your tuition on it!
      ...
      <div class="text-center">
        <p>After applying, talk to your admissions counselor about the ISA Plan.</p>
      </div>
