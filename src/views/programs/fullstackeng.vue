      ...
      <div class="row mt-5">
        <div class="col-md-6 col-lg-7">
          <div class>
            ...
            <p class>
              Projects live and die because of leadership. As a Full-Stack
              Engineer, you are trained in the arts of "Agile Software
              Development" and can help lead the entire development team to
              victory through sound project management, Agile and Lean
              practices, and principled software development techniques.
            </p>
          </div>
          <SalaryBlock
            :amount="121060"
